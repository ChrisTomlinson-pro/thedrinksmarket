...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div 
            ...
            style='background-image: url("/storage/resources/Bigstock-Old-grunge-brick-wall-photos.jpg"); height:100vh; width: 100vw;'
            >

            {{-- Top Banner --}}
            <div id='top-banner' class='flex justify-content-around' style='height:20vh; background: rgba(0, 0, 0, 0.7);'>
            ...
            {{-- Grid --}}
            <div id='prices-grid' class='grid grid-cols-5' style='background: rgba(0, 0, 0, 0.7);'>
                @if($config->running)
